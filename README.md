...
3) To generate a .txt file, click on the "Extract" button and browse or copy the path in the input box to the **.yml** file and click "Open". The program will close after that, so that's all as intended. The generated file can be found in the "\translations" folder, where the .exe file is.
